...
def create_app():
    ...
    app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAME', 'dummyformyweb@gmail.com')
    app.config['MAIL_PASSWORD'] = os.getenv('MAIL_PASSWORD', 'mkia kjxp eucf nfpn')
    app.config['MAIL_DEFAULT_SENDER'] = os.getenv('MAIL_DEFAULT_SENDER', 'dummyformyweb@gmail.com')
